...
<form action="{{route('supplier.update', [$supplier->kd_supp])}}" method="POST"> @csrf 
    ...
    <fieldset> 
        ...
        <div class="form-group row"> 
            ...
            <div class="col-md-5"> 
                <label for="addalamat">Alamat Supplier</label> 
                <input id="addalamat" type="text" name="addalamat" class="form-control" value="{{$supplier->alamat}}"> 
            </div> 
            <div class="col-md-5"> 
                <label for="addtelepon">Telepon Supplier</label> 
