...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-pattern0001 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-2">APLIKASI INVENTORY</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    ...
                    <span><b>Menu Utama 3</b></span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-fw fa-archive"></i>
                    <span><b>Menu Utama 4</b></span></a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Create By: <b>11191127 - Muhammad Fajri Ramadhan</b><br><font size="0.5">Copyright &copy; Your Website 2020</font></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
